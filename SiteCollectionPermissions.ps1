...
New-Item C:\TEMP\PermisosErreius.htm -ItemType file
$OutputReport = "C:\TEMP\PermisosErreius.htm"
$SiteCollURL="http://erreius.errepar.com/sitios/Erreius"
$ScanFolders=$False
$ScanItemLevel=$False
...
#Read more: http://www.sharepointdiary.com/2016/02/sharepoint-site-collection-permission-report-powershell-script.html#ixzz4KAESSwzf